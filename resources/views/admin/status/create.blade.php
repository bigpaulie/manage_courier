...
@section('content')
    ...
    <!-- start: page -->
    <form id="frmcourier" action="{{route('status.store')}}" class="form-horizontal form-bordered" method="POST">
        {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group @if ($errors->has('color_code')) has-error  @endif">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="colorpicker-default form-control colorpicker-element" data-plugin-colorpicker name="color_code" value="{{old('color_code')}}">

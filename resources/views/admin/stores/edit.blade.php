                ...
                <div class="panel-body">
                    ...
                    {{csrf_field()}}
                        <div class="form-group @if ($errors->has('company_name')) has-error  @endif">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="company_name" name="company_name" value="{{$store->profile->company_name}}">
                        ...
                        <div class="form-group @if ($errors->has('first_name')) has-error  @endif">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="first_name" name="first_name" value="{{$store->profile->first_name}}">
                        ...
                        <div class="form-group @if ($errors->has('last_name')) has-error  @endif">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="last_name" name="last_name" value="{{$store->profile->last_name}}">
